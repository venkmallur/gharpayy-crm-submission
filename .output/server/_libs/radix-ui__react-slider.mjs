      ...
      SliderProvider,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Collection.Provider, { scope: props.__scopeSlider, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Collection.Slot, { scope: props.__scopeSlider, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          SliderOrientation,
          {
            ...
            onHomeKeyDown: /* @__PURE__ */ __name(() => !disabled && updateValues(min, 0, { commit: true }), "onHomeKeyDown"),
            onEndKeyDown: /* @__PURE__ */ __name(() => !disabled && updateValues(max, values.length - 1, { commit: true }), "onEndKeyDown"),
            onStepKeyDown: /* @__PURE__ */ __name(({ event, direction: stepDirection }) => {
              if (!disabled) {
      ...
      SliderOrientationProvider,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          SliderImpl,
          {
            ...
            onSlideStart: /* @__PURE__ */ __name((event) => {

...
const formatDistance$1 = /* @__PURE__ */ __name((token, count, options) => {
  let result;
...
const ordinalNumber = /* @__PURE__ */ __name((dirtyNumber, _options) => {
...
const dateLongFormatter = /* @__PURE__ */ __name((pattern, formatLong2) => {
  switch (pattern) {
    case "P":
...
const timeLongFormatter = /* @__PURE__ */ __name((pattern, formatLong2) => {
  switch (pattern) {
    case "p":
...
const dateTimeLongFormatter = /* @__PURE__ */ __name((pattern, formatLong2) => {

...
var createNull = /* @__PURE__ */ __name(() => /* @__PURE__ */ Object.create(null), "createNull");
var nullReplaceEqualDeep = /* @__PURE__ */ __name((prev, next) => replaceEqualDeep(prev, next, createNull), "nullReplaceEqualDeep");
...
__name(validateMatchParams, "validateMatchParams");
...
var defaultGetScrollRestorationKey = /* @__PURE__ */ __name((location) => {
...
__name(parseRedirect, "parseRedirect");
...
var triggerOnReady = /* @__PURE__ */ __name((inner) => {
  if (!inner.rendered) {
    inner.rendered = true;
    return inner.onReady?.();
  }
}, "triggerOnReady");
var resolvePreload = /* @__PURE__ */ __name((inner, matchId) => {
  return !!(inner.preload && !inner.router.stores.matchStores.has(matchId));
}, "resolvePreload");
var buildMatchContext = /* @__PURE__ */ __name((inner, index, includeCurrentMatch = true) => {
...
var getNotFoundBoundaryIndex = /* @__PURE__ */ __name((inner, err) => {
...
var handleRedirectAndNotFound = /* @__PURE__ */ __name((inner, match, err) => {
...
var shouldSkipLoader = /* @__PURE__ */ __name((inner, matchId) => {
  const match = inner.router.getMatch(matchId);
  if (!match) return true;
  if (match.ssr === false) return true;
  return false;
}, "shouldSkipLoader");
var syncMatchContext = /* @__PURE__ */ __name((inner, matchId, index) => {
...
var handleSerialError = /* @__PURE__ */ __name((inner, index, err, routerCode) => {
...
var isBeforeLoadSsr = /* @__PURE__ */ __name((inner, matchId, index, route) => {
...
var setupPendingTimeout = /* @__PURE__ */ __name((inner, matchId, route, match) => {
...
var preBeforeLoadSetup = /* @__PURE__ */ __name((inner, matchId, route) => {
  const existingMatch = inner.router.getMatch(matchId);
...
var executeBeforeLoad = /* @__PURE__ */ __name((inner, matchId, index, route) => {
  const match = inner.router.getMatch(matchId);
...
var handleBeforeLoad = /* @__PURE__ */ __name((inner, index) => {
  const { id: matchId, routeId } = inner.matches[index];
  const route = inner.router.looseRoutesById[routeId];
...
var executeHead = /* @__PURE__ */ __name((inner, matchId, route) => {
  const match = inner.router.getMatch(matchId);
  if (!match) return;
...
var getLoaderContext = /* @__PURE__ */ __name((inner, matchPromises, matchId, index, route) => {
...
var runLoader = /* @__PURE__ */ __name(async (inner, matchPromises, matchId, index, route) => {
  try {
    const match = inner.router.getMatch(matchId);
    try {
...
var loadRouteMatch = /* @__PURE__ */ __name(async (inner, matchPromises, index) => {
...
function buildMiddlewareChain(destRoutes) {
  ...
  for (const route of destRoutes) {
    ...
    if (route.options.validateSearch) {
      const validate = /* @__PURE__ */ __name(({ search, next }) => {
  ...
  const final = /* @__PURE__ */ __name(({ search }) => {
  ...
  const applyNext = /* @__PURE__ */ __name((index, currentSearch, middlewares) => {
  ...
  return /* @__PURE__ */ __name(function middleware(search, dest, _includeValidateSearch) {
    context.dest = dest;
...
var RAW_STREAM_FACTORY_CONSTRUCTOR_BINARY = /* @__PURE__ */ __name((stream) => new ReadableStream({ start(controller) {
  stream.on({
    next(base64) {
      try {
...
var RAW_STREAM_FACTORY_CONSTRUCTOR_TEXT = /* @__PURE__ */ __name((stream) => {
...
function attachRouterServerSsrUtils({ router, manifest, getRequestAssets, includeUnmatchedRouteAssets = true }) {
  ...
  router.serverSsr = {
    ...
    onRenderFinished: /* @__PURE__ */ __name((listener) => renderFinishedListeners.push(listener), "onRenderFinished"),
    onSerializationFinished: /* @__PURE__ */ __name((listener) => serializationFinishedListeners.push(listener), "onSerializationFinished"),
...
__name(findLastClosingTagEnd, "findLastClosingTagEnd");
function transformStreamWithRouter(router, appStream, opts) {
  ...
  if (serializationAlreadyFinished && !initialBufferedHtml) {
    ...
    const safeClose2 = /* @__PURE__ */ __name(() => {
    ...
    const safeError2 = /* @__PURE__ */ __name((error) => {
      if (isStreamClosed2) return;
      isStreamClosed2 = true;
      try {
  ...
  __name(appendRouterHtml, "appendRouterHtml");
  function tryFinish() {
...
export {
  ...
  parseRedirect as u,
  mergeHeaders as v,
  defaultSerovalPlugins as w,
  makeSerovalPlugin as x,

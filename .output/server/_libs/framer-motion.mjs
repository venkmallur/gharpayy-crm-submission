...
const AnimatePresence = /* @__PURE__ */ __name(({ children, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync", propagate = false }) => {
...
function createRenderBatcher(scheduleNextBatch, allowKeepAlive) {
  ...
  const cancel = /* @__PURE__ */ __name((process) => {
...
__name(createProjectionNode$1, "createProjectionNode$1");
...
function createMotionComponentFactory(preloadedFeatures, createVisualElement) {
  return /* @__PURE__ */ __name(function createMotionComponent2(Component, { forwardMotionProps } = { forwardMotionProps: false }) {
...
const isZeroValueString = /* @__PURE__ */ __name((v) => /^0[^.\s]+$/u.test(v), "isZeroValueString");
...
const isNumericalString = /* @__PURE__ */ __name((v) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(v), "isNumericalString");

...
var _a2, _b, _c, _d, _e2, _f, _g, _h, _i, _j, _k, _l, _m, _n2, _o, _p, _q, _r2;
...
__name(Nn, "Nn");
var bn = /* @__PURE__ */ __name((e, r) => Nn(e), "bn"), Se = (_a2 = class extends Error {
  constructor(t, n) {
    super(bn(t));
    this.cause = n;
  }
}, __name(_a2, "Se"), _a2), z = (_b = class extends Se {
  constructor(r) {
    super("parsing", r);
  }
}, __name(_b, "z"), _b), He = (_c = class extends Se {
  constructor(r) {
...
}, __name(_d, "x"), _d), w = (_e2 = class extends Error {
  constructor(r) {
    super(_(2));
  }
}, __name(_e2, "w"), _e2), Q = (_f = class extends Error {
  constructor(r) {
    super(_(3));
  }
}, __name(_f, "Q"), _f), V = (_g = class extends Error {
  constructor(r) {
    super(_(4));
  }
...
}, __name(_j, "Je"), _j), h = (_k = class extends Error {
  constructor(r) {
    super(_(8));
  }
}, __name(_k, "h"), _k), ee = (_l = class extends Error {
  constructor(r) {
    super(_(9));
  }
}, __name(_l, "ee"), _l);
...
var re = /* @__PURE__ */ __name(() => {
...
}, "re"), vn = /* @__PURE__ */ __name((e, r) => {
  e.s(r), e.p.s = 1, e.p.v = r;
}, "vn"), Cn = /* @__PURE__ */ __name((e, r) => {
  e.f(r), e.p.s = 2, e.p.v = r;
}, "Cn"), yt = re.toString(), Nt = vn.toString(), bt = Cn.toString(), Rr = /* @__PURE__ */ __name(() => {
...
}, "Rr"), vt = Rr.toString(), Pr = /* @__PURE__ */ __name((e) => (r) => () => {
  ...
  return n;
}, "Pr"), Ct = Pr.toString(), xr = /* @__PURE__ */ __name((e, r) => (t) => () => {
  ...
  return g;
}, "xr"), At = xr.toString(), Or = /* @__PURE__ */ __name((e) => {
...
__name(ar, "ar");
var Eo = /* @__PURE__ */ __name(() => T, "Eo"), Io = Eo.toString(), qt = /=>/.test(Io);
function sr(e, r) {
...
function Oa(e, r, t, n) {
  ...
  return e.type === 1 || (Xr(e), n.on({ next: /* @__PURE__ */ __name((s) => {
    if (e.state.alive) {
      let i = G(e, r, s);
      i && ie(e, qe(t, i));
    }

...
var N = '[cmdk-group=""]', Y = '[cmdk-group-items=""]', be = '[cmdk-group-heading=""]', le = '[cmdk-item=""]', ce = `${le}:not([aria-disabled="true"])`, Z = "cmdk-item-select", T = "data-value", Re = /* @__PURE__ */ __name((r, o, n) => W(r, o, n), "Re"), ue = reactExports.createContext(void 0), K = /* @__PURE__ */ __name(() => reactExports.useContext(ue), "K"), de = reactExports.createContext(void 0), ee = /* @__PURE__ */ __name(() => reactExports.useContext(de), "ee"), fe = reactExports.createContext(void 0), me = reactExports.forwardRef((r, o) => {
  ...
  let E = reactExports.useMemo(() => ({ subscribe: /* @__PURE__ */ __name((e) => (f.current.add(e), () => f.current.delete(e)), "subscribe"), snapshot: /* @__PURE__ */ __name(() => n.current, "snapshot"), setState: /* @__PURE__ */ __name((e, a, s) => {
    var i, l, g, y;
  ...
  }, "emit") }), []), U2 = reactExports.useMemo(() => ({ value: /* @__PURE__ */ __name((e, a, s) => {
    var i;
  ...
  }), "group"), filter: /* @__PURE__ */ __name(() => p2.current.shouldFilter, "filter"), label: b || r["aria-label"], getDisablePointerSelection: /* @__PURE__ */ __name(() => p2.current.disablePointerSelection, "getDisablePointerSelection"), listId: $2, inputId: _, labelId: q, listInnerRef: I }), []);
  function te(e, a) {
    var i, l;
  ...
  return reactExports.createElement(Primitive.div, { ref: o, tabIndex: -1, ...O, "cmdk-root": "", onKeyDown: /* @__PURE__ */ __name((e) => {
    var s;
  ...
  }, "onKeyDown") }, reactExports.createElement("label", { "cmdk-label": "", htmlFor: U2.inputId, id: U2.labelId, style: Te }, b), B(r, (e) => reactExports.createElement(de.Provider, { value: E }, reactExports.createElement(ue.Provider, { value: U2 }, e))));
...
__name(L, "L");
function P(r) {
  let o = ee(), n = /* @__PURE__ */ __name(() => r(o.snapshot()), "n");

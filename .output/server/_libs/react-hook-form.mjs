...
var isNameInFieldArray = /* @__PURE__ */ __name((names, name) => name.split(".").some((part, index, arr) => !isNaN(Number(part)) && names.has(arr.slice(0, index).join("."))), "isNameInFieldArray");
...
const useFormContext = /* @__PURE__ */ __name(() => React.useContext(HookFormContext), "useFormContext");
...
function createFormControl(props = {}) {
  ...
  const _updateDirtyFields = /* @__PURE__ */ __name((name) => {
  ...
  const validateForm = /* @__PURE__ */ __name(async ({ name, eventType }) => {
    if (props.validate) {
  ...
  const executeBuiltInValidation = /* @__PURE__ */ __name(async ({ fields, onlyCheckValid, name, eventType, context = {
    valid: true,
  ...
  const getValues = /* @__PURE__ */ __name((fieldNames, config) => {
    let values = {
